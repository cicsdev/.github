...
- JCICS - Two collections of Java samples demonstrating how to use the
...
- OSGi and Liberty [Modernised CICS Explorer SDK Samples](https://github.com/search?q=topic%3Aexplorer+org%3Acicsdev+archived%3Afalse&type=repositories)

- Samples showing [OSGi applications that run in CICS](https://github.com/search?q=topic%3Aosgi+org%3Acicsdev+archived%3Afalse&type=repositories)

- Accessing data with [JDBC in CICS Java applications](https://github.com/search?q=topic%3Ajdbc+org%3Acicsdev+archived%3Afalse&type=repositories)

- Samples showing how to [develop Liberty Java applications](https://github.com/search?q=topic%3Aliberty+org%3Acicsdev+archived%3Afalse&type=repositories) and deploy them in CICS Liberty JVM servers

- Examples demonstrating how to [integrate CICS with IBM MQ](https://github.com/search?q=topic%3Amq+org%3Acicsdev+archived%3Afalse&type=repositories)
